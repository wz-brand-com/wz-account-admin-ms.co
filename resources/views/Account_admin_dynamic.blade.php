...
<div class="email-body">
    ...
    <h1
        ...
        Hello {{ $SiteAdminSendMail['name'] }},</h1>
    <p>Your new account on Wizbrand.com has been created!</p>
    <div>
        <p>Please click the button to activate your account
            <a target="_blank" rel="noopener noreferrer" href="https://www.wizbrand.com/password/reset"
        ...
        <a href="https://www.wizbrand.com/password/reset"></a>
        <br /><br />
        <p>
