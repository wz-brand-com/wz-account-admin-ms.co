    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url('{{asset('/img/login-register.jpg')}}');">
            <div class="login-box card shadow">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="{{ route('member.token.email') }}" id="form">
                       {!! @csrf_field() !!} 
                        <h3 class="box-title m-b-20">Register Account 
                       </h3>
                       <input type="hidden" value="{{$membertoken}}" name="bymailtoken">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <div class="col-xs-12">
                                ...
                                <input id="email" class="form-control text-dark" type="email" name="email" placeholder="Email" value="{{$membermail}}" readonly> 
