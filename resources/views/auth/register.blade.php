                ...
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="{{ route('register') }}" id="form">
                       {!! @csrf_field() !!} 
                        ...
                        <!-- captcha code open -->
                         <!-- for custome validation C:\xampp\htdocs\siteadmin\vendor\laravel\framework\src\Illuminate\
                         Foundation\Auth\AuthenticatesUsers.php -->
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-block text-uppercase waves-effect waves-light"><a href="https://www.wizbrand.com" class="text-white">Back to home </a></button>
                            </div>
                        </div>
