...
<div class="container-fluid mystylepic">
    <div class="row">
        ...
        <div class="col-6">
            ...
            <!-- card open -->
            <div class="card create_org_card bg-text">
                        ...
                        <div class="col-lg-12">
                            <form action="{{ route('org-store') }}" method="post"
                                ...
                                <div class="form-group" id="name_form">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="org_name" id="name" class="form-control"
                                            autocomplete="off" />
                                ...
                                <button type="submit" class="btn btn-outline-primary float-left ml-3 fa fa-pencile">
                                    Save </button>

                            </form>

                            <button class="btn btn-outline-primary fa fa-list ml-2"><a
                                    href="{{ url('orgs') }}" class="text_u"> Organization List </a>
                            </button>
                            <!-- footer open -->
                            <button class="btn btn-outline-danger">
                                <a class="waves-effect waves-dark fa fa-power-off"
                                    href="{{ route('logout') }}"
