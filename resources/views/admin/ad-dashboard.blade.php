          ...
          <div class="mdc-layout-grid__inner">
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
              <div class="mdc-card info-card info-card--primary">
                <div class="card-inner">
                <a class="wiz" href="{{route('wizard_slug',['org_slug' =>$org_slug])}}">Wizard</a>
                <h5 class="font-weight-light pb-2 mb-1 border-bottom mt-4"></h5>
                ...
                <div class="card-inner">
                  ...
                  <p class="tx-12 text-muted"> 
                    <span class="text-danger display-4"> 
                      @if(!empty($get_sluged_based_url))
                          {{$get_sluged_based_url}}
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-3-desktop mdc-layout-grid__cell--span-4-tablet">
              <div class="mdc-card info-card info-card--danger">
                <div class="card-inner">
                  <h5 class="card-title">Website Ranking</h5>
                  <h5 class="font-weight-light pb-2 mb-1 border-bottom"></h5>
                  <p class="tx-12 text-muted"> 
                    <span class="text-danger display-4"> 
                      @if(!empty($get_website_rank))
                          {{$get_website_rank}}
            ...
            <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-8-tablet">
              <div class="mdc-card">
                <div class="d-flex d-lg-block d-xl-flex justify-content-between">
                  <div>   {{$org_slug}}
                    <h6 class="card-title">Total Members in Your Organization</h6>
