 ...
 window.addEventListener("load", function() {
   $(".loader").delay(500).fadeOut("slow");
        ...
        columns: [{
            ...
            // },
            {
                    ...
                    render: function(data, type, row) 
                    {
                        ...
                        return '<div class="row"><div class="col-2"><span>'+data['project_name'] + '</span></div></di>'
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    return '<div class="row"><div class="col-5"><button type="button"  id="' +
                        data['id'] +
                        '" class="edit btn btn-primary"><i class="mdi mdi-lead-pencil"></i></button></div><div class="col-2"><button type="button" id="' + data['id'] + '" name="' + data['project_name'] + '"  class="btn btn-danger  delete"><i class="mdi mdi-delete"></i></button></div> </div>'
                },
            },
        ],
    ...
    $('#sample_form').on('submit', function(event) {
        ...
        console.log("in keyword url id save ho rha hai ki nahi" + url);
