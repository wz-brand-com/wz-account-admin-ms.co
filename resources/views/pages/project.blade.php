        ...
        <div class="card-body">
            <div class="tabs">
                ...
                <div id="tab01" class="tab-contents">
                    <br><button type="button" name="create_record" id="create_record" class="btn btn-primary ">Add New Project</button>
...
<script>
    ...
    // manger will be call on load page close
        ...
        var dt = $('#projectTable').DataTable({
            ...
            //    wizard open
            {
                    ...
                    render: function (data, type, row) {
                        return '<div class="row"><div class="col-6"><a target="_blank"href="/orgs/'+data['slugname']+'/start-wizard/' +data['project_name']+ '/'+ data['id']+ ' "> Start Wizard</a></div> </div>'
                    },
                },
            //    wizard close
                {
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<div class="row"><div class="col-6"><button type="button"  id="' +
                            ...
                            data['id'] + '" name="' + data['project_name'] +
        ...
        //################################################## wizardmodaltarget open ################################
        // $(document).on('click', '.wizardmodaltargetopen', function () {
        //     console.log('working wizardmodaltargetopen button');
        //     var pn_id = $(this).attr('id');
        //     console.log("id ka value aaa rha hai" + id);
        //     var getting_pn_name = $(this).attr('project_name');
        //    console.log("getting pn " + getting_pn_name);

        //     $.ajax({
        //         type: "get",
        //         data: {},
        //         url: "{{url('targetmodelwizard')}}/" + pn_id +'/'+ getting_pn_name ,
        //         headers: {
        //             "Authorization": "Bearer " + localStorage.getItem('a_u_a_b_t')
        //         },
        //         success: function (html) {
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<div class="row"><div class="col-4"><button type="button"  id="' +
                            data['id'] +
                            '" class="edit_url btn btn-primary"><i class="mdi mdi-lead-pencil"></i></button></div><div class="col-2"><button type="button" id="' +
                            data['id'] + '" name="' + data['url'] +
                            '"  class="btn btn-danger  deletes"><i class="mdi mdi-delete"></i></button></div> </div>'
                    },
                },
            ],
