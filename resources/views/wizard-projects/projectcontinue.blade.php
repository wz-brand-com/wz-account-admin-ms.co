                ...
                <div class="row">
                    <div class="col-md-8">
                        <button class="button ml-3 mt-4" name="create_project_wizard" id="create_project_wizard"
                            style=""><span>Continue&nbsp;Wizard</span>
                        </button>
                        <a href="{{route('projectwithslug',[ 'org_slug' => $org_slug])}}">
                            <button
                                class="button1 ml-3 mt-4 fal fa-arrow-alt-circle-left" name="create_project_wizard" id="create_project_wizard"
                                style=""><span> Back</span>
                            </button>
                        </a>
                    </div>
                    <br>
                                            ...
                                            <div class="form-group" id="project_form">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" readonly class="form-control"
                                                        value="{{$project_name}}" name="project_name" id="project_name">
                                                    <input type="hidden" name="wizard_project_id"
                                                        value="{{$project_id_from_project}}">
                                                </div>
                                                <span
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control" name="facebook"
                                                            id="facebook_url_id" aria-describedby="basic-addon2">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-outline-warning"
                                                                id="skip_facebook_id" type="button">skip</button>
                                                        </div>
                                                    </div>
