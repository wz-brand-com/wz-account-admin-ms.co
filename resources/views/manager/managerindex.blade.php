...
@section('title','Manager Invite Member')
@section('content')
...
{{-- <div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Manager Section</h3>
    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" id="sample_form" class="form-horizontal"
                                            ...
                                            <div class="form-group" id="name_form">
                                                ...
                                                <!-- autosearch open -->
                                                <input type="text" class="form-control typeahead" id="user_id" name="u_org_user_email" autocomplete="off">
                                                <!-- autosearch close -->
                                            ...
                                            <div class="form-group" id="name_form">
                                                ...
                                                <option value="default" class="form-control text-dark">Select Role </option>
                                                        ...
                                                        <option value="2" name="manager">Manager</option>
                                                        <option value="3" name="user">User</option>
                                                </select>
...
<script src="{{asset('js/autocomplete-email.js')}}"></script>
<script type="text/javascript">
