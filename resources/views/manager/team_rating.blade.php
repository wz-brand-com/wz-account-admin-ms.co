...
@section('title','Manager TeamRating')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="name_form">
                                                        ...
                                                        <select name="rating_user_name" id="rat_user_name" class="w-100 p-2">
                                                            <option value="" class="form-controll text-dark">Select Name
                                                            </option>

                                                                <option value="{{Auth::user()->name}}">{{Auth::user()->name}}</option> 
                                                                @foreach($teamrating_all_user_name as $manager)
                                                                @if(Auth::user()->name !== $manager['u_org_user_name'])  
                                                                <option  value="{{$manager['u_org_user_name']}}" name="{{$manager['u_org_user_id']}}" >{{$manager['u_org_user_name']}}</option>
                                                                @endif
                                                                @endforeach
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" id="name_form">
                                                        ...
                                                        <select name="rating_manager_name" id="rat_manager_name" class="w-100 p-2">
                                                            <option value="" class="form-controll text-dark">Select
                                                                Name </option>
                                                                <option value="{{Auth::user()->name}}">{{Auth::user()->name}}</option> 
                                                                @foreach($teamrating_all_manager as $manager)
                                                                @if(Auth::user()->name !== $manager['u_org_user_name'])  
                                                                <option  value="{{$manager['u_org_user_name']}}" name="{{$manager['u_org_user_id']}}" >{{$manager['u_org_user_name']}}</option>
                                                                @endif
                                                                @endforeach
...
<script>
    $(document).ready(function () {
        ...
        $('#sample_form').on('submit', function (event) {
            ...
            // var team_user_email = $("#name option:selected").attr("name");
            // $('#email').val(team_user_email);
            // console.log('user email ka value aa raha hai' + team_user_email);
