...
@section('title','Manager SocialRank')
...
{{-- <div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Social Ranking Section</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Ranks & Ratings</a></li>
            <li class="breadcrumb-item active">Social Ranking</li>
        </ol>
    </div>
</div> --}}
<br><br><br>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <button type="button" name="create_record" id="create_record"
                                    ...
                                    <button type="button" name="ytsubscriber" id="ytsubscriber" class="btn waves-effect waves-light btn-danger"><i class="mdi mdi-youtube-play"></i> Subcriber</button>
 ...
 window.addEventListener("load", function() {
   $(".loader").delay(500).fadeOut("slow");
    ...
    $("#ytsubscriber").click(function(){
        ...
        $("#socialTitle").text("YT Subsciber View");
