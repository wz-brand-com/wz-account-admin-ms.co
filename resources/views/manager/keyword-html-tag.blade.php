                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form method="post" id="sample_form" class="form-horizontal"
                                            ...
                                            <div class="form-group" id="name_form">
                                                ...
                                                <div class="col-md-12">
                                                    <select name="url" id="url" class="w-100 p-2">
                                                        ...
                                                        @foreach($keywordurl as $key)
                                                            <option value="{{$key->url}}" class="form-controll text-dark">{{$key->url}}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group" id="name_form">
                                                ...
                                                <span class="text-danger mt-2">seotraining seocourse seoengineer</span>
                                                </span>
                                                <!-- information close -->
                                            </div>
...
('[id=keyword]').tagify({duplicates :false});
