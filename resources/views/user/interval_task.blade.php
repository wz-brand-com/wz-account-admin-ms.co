...
@section('title','User Interval Task')
                                            ...
                                            <div class="row">
                                                <div class="col-md-6" id="name_form"> 
                                                    <div class="form-group">
                                                        ...
                                                        @foreach($find_org_user_email as $teamuser)
                                                    <option  value="{{$teamuser['u_org_user_email']}}" name="{{$teamuser['u_org_user_id']}}" >{{$teamuser['u_org_user_email']}}</option>
                                                        @endforeach
