...
{{-- <div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Project Section</h3>
    </div>
            ...
            <div class="tabs">
                <div class="tab-button-outer">
                    <ul id="tab-button">
                        ...
                        {{-- <li><a href="#tab03">Add New Keyword</a></li> --}}
                    ...
                    <table id="projectTable" class="table">
                        <thead>
                            <tr>
                                ...
                                <th data-column_name="project_name" width="35%">Project Name</th>
                                <th data-column_name="project_manager" width="35%">Project Manager</th>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h5 class="modal-title text-white" id="exampleModalLabel">New Projects</h5>
                                    ...
                                    <form method="post" id="sample_form" class="form-horizontal"
                                        ...
                                        <div class="form-group" id="name_form">
                                            ...
                                            <select name="project_manager" id="project_manager" class="w-100 p-2">
                                                <option value="" class="form-controll text-dark">Select Manager
                                                </option>
                                                ...
                                                <option value="{{$tsk_manger['u_org_user_email']}}"
                                                    name="{{$tsk_manger['u_org_user_id']}}">
                                                    {{$tsk_manger['u_org_user_email']}}</option>
                                                @endif
                                                @endforeach --}}
                                            </select>
                                        </div>
                ...
                <div id="tab02" class="tab-contents">
                        ...
                        <thead>
                            <tr>
                                <tr>
                                    ...
                                    <th width="45%" class="text-left">Project</th>
                                    <th width="45%" class="text-left">Web URLs</th>
                                </tr>
                    ...
                    <div id="formModal_urlss" class="modal fade" role="dialog">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-primary">
                                    <h5 class="modal-title text-white" id="exampleModalLabel">New Urls</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
