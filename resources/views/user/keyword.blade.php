    ...
    $(document).on('click', '.edit', function() {
        ...
        $.ajax({
            ...
            success: function(html) {
                ...
                keyword += '<span class="custom-tag">' + value.value +
                             '</span>';
                });
                ...
                // keyword diplay on edit button  open
                // var keyword = '';
                // console.log('keyword ka value aaa raha hai ki nahi'+keyword);
                //     $.each(JSON.parse(html.data.keyword), function (key, value) {
                //         // console.log(key)
                        //  keyword += '<span class="custom-tag">' + value.value +
                        //      '</span>';
                ...
                //     });
                // keyword diplay on edit button  close

                $('#project_name').val(html.data.project_name);
                $('#url').val(html.data.url);
                $('#keyword').val(html.data.keyword);
