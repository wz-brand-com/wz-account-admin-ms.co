...
class RegisterController extends Controller
{
  ...
  public function userActivateStore(Request $request)
  {
    ...
    if($check_user_email){
      ...
      $match_email = Usersorganization::where('u_org_user_email',$get_email_by_token)->first();
      $match_email->u_org_user_id = $get_email_id;
      $match_email->u_org_user_name = $get_user_name;
      $match_email->save();
      $add_profile = new Addprofile();
