...
class LinkController extends Controller
{
    ...
    public function index($org_slug)
    {
        ...
        $a_user_api_bearer_token = $this->getAddUrlAccessToken();
        ...
        // ##################### if condition apply for checking if organization has been blocked not allow to access dashboard 
         ...
         if($getting_roll_id ==1){
             return view('pages.addurl',compact('org_slug','getting_roll_id','a_user_api_bearer_token','slug_id')); 
         } // first if close
         if($getting_roll_id ==2){
             return view('manager/addurl',compact('org_slug','getting_roll_id','a_user_api_bearer_token','slug_id'));
         } // second if close
         return view('user/addurl',compact('org_slug','getting_roll_id','a_user_api_bearer_token','slug_id'));
    ...
    // for generate token
    private function getAddUrlAccessToken(){
