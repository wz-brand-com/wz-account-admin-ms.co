    ...
    var dt = $('#wizardTable').DataTable({
        ...
        columns: [{
          ...
          
            {
                data: null,
                render: function(data, type, row) {
                    return '<div class="row"><div class="col-3"><button type="button"  id="' + data['id'] +'" class="editWizardBtn btn btn-primary"><i class="mdi mdi-lead-pencil"></i></button></div><div class="col-3"><button type="button" id="' + data['id'] +'" class="btn btn-info viewAllValueModalLong"><i class="fa fa-eye"></i></button></div>       <div class="col-2"><button type="button" id="' +data['id'] + '" name="' + data['url'] +  '"  class="btn btn-danger deleteWizardProject"><i class="mdi mdi-delete"></i></button></div> </div>'
                },
            },
        ],
    ...
    $(document).on('click', '.viewAllValueModalLong', function () {
        ...
        $.ajax({
            ...
            success: function success(html) {
                ...
                $('#github_name_view').html(github_view_title);
